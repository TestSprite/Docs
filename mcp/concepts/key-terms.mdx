...
<Tabs>
  ...
  <Tab title="When to use">
    Use `Generate` when you need to create tests for the first time:
  ...
  <Tab title="What happens">
    `Generate` follows this workflow:
...
<Tabs>
  ...
  <Tab title="When to use">
    Use `Regenerate` when you need to recreate tests from scratch:
  ...
  <Tab title="What happens">
    `Regenerate` follows this workflow:
...
<Tabs>
  <Tab title="When to use">
    Use `Run` when executing tests for the first time:
...
<Tabs>
  ...
  <Tab title="When to use">
    Use `Rerun` when executing existing tests again:
...
<Tabs>
  <Tab title="Common healing scenarios">
    `Healing` addresses these common test fragility issues:
...
<div className="full-width-table" style={{ gridTemplateColumns: '1fr 1fr' }}>
  <div className="table-header" style={{ padding: '12px', fontSize: '14px' }}>What Healing is Not</div>
  <div className="table-header" style={{ padding: '12px', fontSize: '14px' }}>What Healing Is</div>
  <div className="table-cell" style={{ padding: '12px', fontSize: '14px', borderBottom: '1px solid var(--table-border-color, #e5e7eb)' }}><Icon icon="x" size={16} color="#ef4444" /> Masking real product bugs</div>
  <div className="table-cell" style={{ padding: '12px', fontSize: '14px', borderBottom: '1px solid var(--table-border-color, #e5e7eb)' }}><Icon icon="check" size={16} color="#22c55e" /> Making tests resilient to non-functional code changes</div>
  <div className="table-cell" style={{ padding: '12px', fontSize: '14px' }}><Icon icon="x" size={16} color="#ef4444" /> Making tests pass when they should fail</div>
  <div className="table-cell" style={{ padding: '12px', fontSize: '14px' }}><Icon icon="check" size={16} color="#22c55e" /> Reducing test maintenance busywork</div>
</div>
...
<div className="full-width-table" style={{ gridTemplateColumns: '0.8fr 1.1fr 1.1fr' }}>
  ...
  <div className="table-header" style={{ padding: '12px', fontSize: '14px' }}>Codebase</div>
  <div className="table-header" style={{ padding: '12px', fontSize: '14px' }}>Code Diff</div>
  <div className="table-cell" style={{ padding: '12px', fontSize: '14px', borderBottom: '1px solid var(--table-border-color, #e5e7eb)' }}>What it tests</div>
  <div className="table-cell" style={{ padding: '12px', fontSize: '14px', borderBottom: '1px solid var(--table-border-color, #e5e7eb)' }}>Tests the entire project</div>
  <div className="table-cell" style={{ padding: '12px', fontSize: '14px', borderBottom: '1px solid var(--table-border-color, #e5e7eb)' }}>Tests only changed files/features (based on git diff)</div>
  <div className="table-cell" style={{ padding: '12px', fontSize: '14px', borderBottom: '1px solid var(--table-border-color, #e5e7eb)' }}>Use cases</div>
  <div className="table-cell" style={{ padding: '12px', fontSize: '14px', borderBottom: '1px solid var(--table-border-color, #e5e7eb)' }}>New projects, major releases, comprehensive audits</div>
  <div className="table-cell" style={{ padding: '12px', fontSize: '14px', borderBottom: '1px solid var(--table-border-color, #e5e7eb)' }}>Feature branches, incremental development, quick validation</div>
  <div className="table-cell" style={{ padding: '12px', fontSize: '14px', borderBottom: '1px solid var(--table-border-color, #e5e7eb)' }}>Speed</div>
  <div className="table-cell" style={{ padding: '12px', fontSize: '14px', borderBottom: '1px solid var(--table-border-color, #e5e7eb)' }}>Takes longer</div>
  <div className="table-cell" style={{ padding: '12px', fontSize: '14px', borderBottom: '1px solid var(--table-border-color, #e5e7eb)' }}>Fast feedback</div>
  <div className="table-cell" style={{ padding: '12px', fontSize: '14px' }}>Coverage</div>
  <div className="table-cell" style={{ padding: '12px', fontSize: '14px' }}>Full coverage</div>
  <div className="table-cell" style={{ padding: '12px', fontSize: '14px' }}>Recent changes only</div>
</div>
...
<Tabs>
  <Tab title="What's in it">
    The `Normalized PRD` contains structured information:
  ...
  <Tab title="Why it matters">
    Understanding why `Normalized PRD` exists:
