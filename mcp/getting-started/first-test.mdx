...
``` text Project Structure Example expandable
my-project/
...
``` text Expandable After Testing Project Structure Example expandable
testsprite_tests/
├── tmp/
...
**Test Plan Generated:**
```json Expandable Test Plan Example expandable
{
  "testCases": [
    {
      "id": "TC001",
...
**Test Report Summary:**
```json Expandable Test Report Summary Example expandable
{
  "summary": {
    "totalTests": 18,
    "passed": 12,
