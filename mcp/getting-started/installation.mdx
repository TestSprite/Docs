...
2. In Trae, click `Setting` icon at the top of IDE.
  <Frame>
    <img src="../../images/trae.png"  alt="trae" />
  </Frame>
3. Select `MCP` in Setting page's left sidebar.
  <Frame>
    <img src="../../images/trae-mcp.png"  alt="trae" />
  </Frame>
4. Select `Add > Add from Marketplace` in Setting page's left sidebar.
  <Frame>
    <img src="../../images/trae-add.png"  alt="trae" />
  </Frame>
...
6. If you are in Trae IDE mode, select **Builder with MCP** in editor’s agent panel and start testing.
  <Frame>
    <img src="../../images/trae-builderwithmcp.png"  alt="trae" />
  </Frame>
</Tab>
...
2. Go to `Chat` → `Auto-Run` → `Auto-Run Mode` and change the setting to **"Ask Everytime"** or **"Run Everything"**
  ...
  <Frame>
  <img src="../../images/Antigravity-mcp.png"  alt="Cursor Success" />
  </Frame>
  2. **Click** on **"Manage MCP Servers"**.
  <Frame>
  <img src="../../images/Antigravity-mcp-server.png"  alt="Cursor Success" />
  </Frame>
  3. **Click** on **"View raw config"**.
  <Frame>
  <img src="../../images/Antigravity-raw-config.png"  alt="Cursor Success" />
  </Frame>
  4. **Add** the following configuration to `mcp_config.json`:

     ```json icon="code" Antigravity Configuration
     {
       "mcpServers": {
         "TestSprite": {
           "command": "npx",
