...
<div className="full-width-table" style={{ gridTemplateColumns: '0.8fr 1.1fr 1.1fr' }}>
  ...
  <div className="table-cell" style={{ padding: '12px', fontSize: '14px', borderBottom: '1px solid var(--table-border-color, #e5e7eb)' }}><kbd>Test case creation</kbd></div>
  ...
  <div className="table-cell" style={{ padding: '12px', fontSize: '14px', borderBottom: '1px solid var(--table-border-color, #e5e7eb)' }}><kbd>Setup</kbd></div>
  ...
  <div className="table-cell" style={{ padding: '12px', fontSize: '14px', borderBottom: '1px solid var(--table-border-color, #e5e7eb)' }}><kbd>Debugging</kbd></div>
  ...
  <div className="table-cell" style={{ padding: '12px', fontSize: '14px', borderBottom: '1px solid var(--table-border-color, #e5e7eb)' }}><kbd>Integration</kbd></div>
  ...
  <div className="table-cell" style={{ padding: '12px', fontSize: '14px' }}><kbd>Coverage</kbd></div>
