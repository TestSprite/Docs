...
<Steps>
  ...
  <Step title="Add new test cases">
    ...
    <Note>You can also use AI IDEs like Cursor or Trae to help reformat them to match TestSprite's standard.</Note>
        ...
        ```json Expandable Test Case Example expandable
    ### New Test Case
    {
      "id": "TC013",
...
| Action | Description |
| :--- | :--- |
| **Rerun** | Quick re-execution of existing tests |
| **Regenerate some** | Edit specific test case descriptions <Icon icon="arrow-right" size={12} /> prompt rerun |
| **Regenerate all** | Delete `testsprite_tests` folder <Icon icon="arrow-right" size={12} /> prompt rerun project tests |
| **Add/import** | Append new cases in test plan <Icon icon="arrow-right" size={12} /> rerun to generate code |
