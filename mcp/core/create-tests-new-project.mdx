...
```json Expandable Generated Output expandable
{
  "tech_stack": [
    "React",
    "TypeScript",
...
```json Expandable Generated PRD Structure expandable
{
  "meta": {
...
```json Expandable Generated Test Plan expandable
[
  {
    "id": "TC001",
...
```python Expandable Generated Test Code Example expandable
