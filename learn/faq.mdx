...
<AccordionGroup>
  ...
  <Accordion title="Can I customize test scenarios?">
    ...
    - **Natural Language**: Describe test scenarios in your own words
...
Still have questions? [Contact our support team <Icon icon="arrow-up-right-from-square" size={12} />](https://calendly.com/contact-hmul/schedule) or check out our [comprehensive documentation](../../mcp/getting-started/introduction). 