...
| Capability | Command |
| :--- | :--- |
| Write the TestSprite skill files — verification-loop (`testsprite-verify`) and first-run onboarding (`testsprite-onboard`) — for Claude Code (GA), Cursor, Cline, Antigravity, or Codex (all experimental except Claude) | `agent install` |
