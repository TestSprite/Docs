...
<Tip>
Run `testsprite doctor` first. It checks your CLI version, Node runtime, active profile, API endpoint, credentials, live connectivity, and whether the verify skill is installed — often the fastest way to find out what's wrong before digging through the sections below.
</Tip>
...
- Confirm your Node version is 20.19+, 22.13+, or 24+ (21.x/23.x are not supported): `node --version`.
